...
const form = useForm({
    ...
    status: props.driver?.status || 'activo',
    shift: props.driver?.shift || 'mañana',
    ...
    has_hazmat_cert: props.driver?.has_hazmat_cert || false,
    ...
    vehicle_id: props.driver?.vehicle_id || ''
});
